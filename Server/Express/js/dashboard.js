var redirect_uri = "https://shufflesound.com/dashboard/";
...
function updateUser() {
  fetch("/api/updateUser/" + localStorage.getItem("access_token"))
    .then((response) => response.json())
    .then((data) => console.log(data));
}

function getReccomendations() {
  fetch("/api/getMusic/" + localStorage.getItem("access_token"))
    .then((response) => response.json())
    .then((data) => console.log(data));
}

function sendUserData() {
  fetch("/api/userData/" + localStorage.getItem("access_token"))
    .then((response) => response.json())
    .then((data) => console.log(data));
}
...
function addSearchResult(item, index) {
...
function handleSearchResponse() {
  ...
  console.log(tracks);
  tracks.forEach((item, index) => addSearchResult(item, index));
}
...
function play() {
  ...
  let searchResult = document.getElementById("searchResult").value;
  let body = {};
